...
The **stationary state** of this randon process is studied in order to estimate **average performance** (blocking probability, mean delay, mean utilization rate, etc.)
